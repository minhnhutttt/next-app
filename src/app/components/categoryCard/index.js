...
export default function CategoryCard({ imgSrc, title, content, answer, sm = false  }) {
  return (
    <div className={`bg-white border border-black ${sm ? 'max-w-[290px] pt-3 px-3' : 'max-w-[606px] p-4'}`}>
     <div className="">
