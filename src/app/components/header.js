...
export default function Header() {
    return (
        <header className="flex items-center justify-between h-20 md:h-[110px] px-5 md:px-[45px]">
            <Link href="/" className="text-[20px] md:text-[42px] text-black font-dela duration-200 hover:opacity-75">
                次世代ドメイン
            </Link>
            <Link href="#" className="flex items-center justify-center w-[140px] md:w-[320px] h-10 md:h-[78px] text-[12px] md:text-[24px] font-bold font-zenkaku bg-[#98FE01] md:rounded-[50px] rounded-[25px] relative px-6 md:px-10 md:tracking-[0.2em] mr-2  duration-200 hover:opacity-75">
                <span>今すぐLINE登録</span>
