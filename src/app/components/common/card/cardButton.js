...
export default function CardButton({ openModal , children }) {
  return (
    <div className="h-[67px] md:h-[87px] flex justify-center px-5">
      <button
        type="button"
        onClick={openModal}
        className="group h-[60px] md:h-[80px] w-full max-w-[500px] border-b-[7px] border-black/60 box-content rounded-[10px] duration-300 hover:border-b hover:mt-[6px] relative"
      >
