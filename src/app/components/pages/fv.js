...
export default function FV() {
    return (
      <div className="w-full max-w-[1440px] mx-auto md:pb-[140px] pb-[70px]">
          ...
          <div className="px-5">
            <div className="flex place-content-center mx-auto mt-[-2.2%] mr-[5.5%]">
            ...
            <div className="w-full max-w-[1260px] mx-auto flex max-md:flex-col-reverse items-center md:items-end justify-between pr-2.5 mt-10 xl:mt-[-3.5%] md:gap-10 gap-8">
              <div className="flex flex-1 gap-4 md:items-center max-md:flex-col md:gap-6 xl:pb-9 max-xl:flex-wrap max-xl:justify-center">
                <h3 className="leading-none text-white font-dela">
                ...
                <div className="md:space-y-[30px] space-y-5">
                  ...
                  <Link href="#" className="md:text-[20px] text-[14px] font-bold text-[#2A5297] flex items-center justify-center gap-2 md:w-[280px] w-[240px] md:h-[62px] h-12 rounded-[50px] bg-white duration-150 hover:opacity-75">
