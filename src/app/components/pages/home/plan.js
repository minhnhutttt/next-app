...
export default function Plan() {
  ...
  return (
    <div
      id="plan"
      className="overflow-hidden bg-white px-5 pb-[70px] pt-[60px] md:pb-[110px] md:pt-[100px]"
    >
      <div className="mx-auto w-full max-w-[400px] md:max-w-[1030px]">
        <h3
          ref={animateRefs}
          className="text-center text-[18px] font-bold md:text-[42px]"
        >
          料金プラン
        </h3>
        <p
          ref={animateRefs}
          className="mt-2 text-center text-[16px] font-bold md:text-[28px]"
        >
        ...
        <div className="mt-10 flex justify-center rounded-[26px] bg-white/90 px-5 [box-shadow:0px_4px_50px_0px_rgba(0,_0,_0,_0.10)] md:mt-[128px]">
          <div className="flex w-full justify-center gap-10 py-10 max-md:flex-col max-md:items-center md:max-w-[865px] md:py-11 lg:gap-20">
            <div
              ref={animateRefs}
              className="max-md:rounded-[26px] max-md:bg-white max-md:p-5 max-md:[box-shadow:0px_20px_34px_0px_rgba(0,_64,_158,_0.30)]"
            >
            ...
            <div
              ref={animateRefs}
              className="rounded-[26px] border-2 border-[#22ABF3] bg-white px-5 pb-8 pt-6 [box-shadow:0px_20px_34px_0px_rgba(0,_64,_158,_0.30)] md:mt-[-110px] md:w-[292px] md:border-4 md:px-[30px] md:pb-[46px] md:pt-10"
            >
