    ...
    >
      ...
      >
        <div className="flex items-center gap-4 md:gap-8">
          <p className="font-roboto text-[20px] font-bold uppercase tracking-widest text-[#2A5297] md:text-[32px]">
            q
          </p>
      ...
      <div ref={contentRef} className="h-0 overflow-hidden">
        <div className="pb-4 pl-8 text-[14px] leading-[1.6] text-black md:w-[85%] md:pb-7 md:pl-16 md:text-[16px]">
          {awnser}
        </div>
      </div>
    </div>
