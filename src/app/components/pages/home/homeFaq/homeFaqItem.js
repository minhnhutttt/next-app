...
export default function HomeFaqItem({ id, question, awnser }) {
  ...
  return (
    <div className="space-y-2 border-b border-[#313333] px-3 py-5 md:space-y-4 md:px-5 md:pb-10 md:pt-11">
      <button
        type="button"
      ...
      >
        <div className="flex items-center gap-4 md:gap-8">
          ...
          <p className="text-left text-[16px] font-bold tracking-tight md:text-[22px]">
            {question}
          </p>
        </div>
        <div
      ...
      {open && (
        <div className="flex pl-11 md:pl-20">
          <p className="text-[14px] leading-[1.6] md:w-[85%] md:text-[16px]">
            {awnser}
          </p>
        </div>
      )}
