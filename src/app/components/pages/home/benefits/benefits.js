...
export default function Benefits() {
    return (
      <>
      <div className="bg-[url('/bg-benefits.png')] bg-no-repeat bg-bottom bg-[length:100%_auto] pb-[35px] md:pb-[47px]">
        <div className="w-full md:max-w-[1400px] max-w-[440px] mx-auto px-2.5">
          <Title>NFTクーポンの特典</Title>
          <div className="flex justify-center my-[3%]">
            <div className="text-[18px] md:text-[36px] font-bold leading-[1.75] tracking-wider">
              ① デジタルウォレット管理 <br />
              ② 環境にやさしい <br />
              ③ シャア(拡散)が簡単 <br />
              ④ 使う人もお店もお得
          ...
          <div className="flex justify-center">
            <p className="text-[16px] md:text-[24px] font-medium">
              最新NFTクーポンで、ショッピングやお出かけがもっと簡単に。<br className="max-md:hidden" />
              紙からNFTへ、未来のクーポンを楽しもう！
            </p>
          </div>
          <div className="grid md:grid-cols-2 mt-[5.8%]">
      ...
      <div className="flex justify-center md:mt-[-47px] mt-[-35px]">
