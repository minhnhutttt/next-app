...
export default function FV() {
    return (
        <div className="pt-3 md:pt-[25px] px-2 md:px-5">
            <div className="w-full max-w-[1380px] mx-auto md:min-h-[670px] flex items-center justify-center flex-col overflow-visible bg-white py-4 md:py-[23px] px-2 md:px-[18px] md:rounded-[20px] rounded-[10px]">
                <div className="w-full h-full flex-1 transition-transform duration-300 [transform-style:_preserve-3d]">
                    ...
                    <div className="relative md:w-[calc(100%-10px)] w-[calc(100%-8px)] md:h-[calc(100%-10px)] h-[calc(100%-8px)] md:max-w-[1166px] max-w-[400px] px-3 md:px-5 mx-auto text-black grid col-span-3 pb-[6%] pt-[5%]">
                            <figure className="col-[1_/_2] row-[1_/_3] mr-5 md:mr-10 max-md:flex max-md:justify-end max-md:items-center">
                            ...
                            <div className="pr-5 max-w-[915px] flex-1 md:col-[2_/_4] md:row-[1] col-[2] row-[1]">
                                <h1 className="font-dela leading-[1.3]"><span className="text-[28px] md:text-[66px]">WEB3.0</span><span className="text-[20px] md:text-[51px]">でも</span><br className="md:hidden" /><span className="text-[32px] md:text-[80px]">自分らしく</span></h1>
                                <p className="text-[16px] md:text-[29px] font-dela">次世代ドメイン（＝Web3.0アカウントの名前）を簡単取得</p>
                            </div>
                            <div className="space-y-2.5 md:col-[2_/_4] md:row-[2] col-[1_/_3] row-[3] max-w-[915px] mt-4">
                                    <div className="flex gap-x-0.5 gap-y-1.5 flex-wrap">
