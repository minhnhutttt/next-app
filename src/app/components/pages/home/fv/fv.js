...
export default function FV() {
  ...
  return (
    <div className="px-2 pt-3 md:px-5 md:pt-[25px]">
      <div
        ref={fvRef}
        className="mx-auto flex w-full max-w-[1380px] flex-col items-center justify-center overflow-visible rounded-[10px] bg-white px-2 py-4 md:min-h-[670px] md:rounded-[20px] md:px-[18px] md:py-[23px]"
      >
