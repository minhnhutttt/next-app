...
export default function FaqItem({ question, awnser }) {
  ...
  return (
    <div
      ref={animateRefs}
      className="space-y-2 rounded-[20px] bg-white p-4 md:px-8 md:pb-8 md:pt-10"
    >
      <button
        type="button"
      ...
      >
        <div className="flex items-center gap-4 md:gap-8">
          <p className="font-roboto text-[18px] font-bold uppercase tracking-widest text-[#D80000] md:text-[32px]">
            q
          </p>
...
<circle cx="24" cy="24" r="23.5" transform="rotate(-180 24 24)" stroke="#D80000"/>
<path d="M28.2666 21.8672L24 26.1339L19.7333 21.8672" stroke="#D80000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
