...
const faq = [
  {
    ...
    awnser: (
      <>
        「ギガ二刀流Wi-Fi
        武将プラン」は、高速な通信速度と大容量のストレージを提供するサービスです。このサービスを利用することで、快適なインターネット環境を楽しむだけでなく、豊富なデータをオンラインストレージに保存することができます。日々の生活をより充実させるためのサービスです。
      </>
    ),
  },
  {
    ...
    awnser: (
      <>
        商品購入専用ページから支払い方法と発送先をご入力いただきご注文ください。'
      </>
    ),
  },
  {
    ...
    awnser: (
      <>
        端末ご購入時は、100GB付きモデルになっています。それを使い切るまでは、追加費用はかかりません。
        <br />
        初回にご購入いただいた端末のGBが無くなりましたら、追加GBチャージをご購入いただくシステムですので、追加チャージされる場合は、別途費用が発生いたします。
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    awnser: (
      <>
        通信ギガやストレージを使い切ると、インターネット・ストレージがご利用できなくなります。
        <br />
  ...
  },
  {
    ...
    awnser: <>ポケットWi-Fiはパスワードで保護され、安全な接続を提供します。</>,
  },
  {
    id: 10,
  ...
  },
  {
    ...
    awnser: (
      <>
        返品や交換はできません。
        <br />
        お届け日より7日以内（到着日を含む）に初期不良とみられる不具合が発生した場合、
        弊社にて交換させて頂きますので、症状など詳細をご連絡ください。
      </>
    ),
  },
];
