export default function Services() {
    return (
        <div className="md:pt-12 pt-6 md:pb-[110px] pb-16 w-full md:max-w-[1260px] max-w-[480px] mx-auto px-5">
            ...
            <div className="flex justify-center md:mb-[42px] mb-5">
                <div className="w-full max-w-[320px] md:max-w-[703px] h-[55px] md:h-[74px] flex">
                    ...
                    <button type="submit" className="w-[80px] md:w-[141px] h-full flex items-center justify-center bg-[#0152A8] text-white md:text-[23px] font-bold">検索</button>
                </div>
            </div>
            <div className="w-full md:max-w-[798px] max-w-[400px] mx-auto bg-[#eee] md:rounded-[20px] rounded-[10px] md:text-[20px] text-[16px] tracking-[0.039em] text-[#111] leading-[1.3] md:p-[30px] p-4">
