...
export default function ModernPeople() {
    return (
      <div className="bg-[url('/images/background-modern-people.png')] bg-[length:100%_auto] bg-no-repeat bg-left-bottom flex items-end relative md:pt-[72px] pt-10 md:pb-[140px] pb-20 px-5">
        <div className="w-full md:max-w-[1280px] max-w-[440px] mx-auto flex justify-end pl-10 md:pl-[130px]">
            <div className="w-full max-w-[900px]">
                ...
                <div className="bg-white/40 px-4 py-12 md:p-8 lg:p-12 md:mt-16 mt-20 rounded-[30px] relative">
                    <figure className="absolute lg:top-[-150px] md:top-[-120px] -top-20 -left-12 md:left-[-130px]">
                        <img className="max-md:w-[140px] max-lg:w-[220px]" src="/images/giga-wifi-circle.png" alt="" />
                    </figure>
                    <div className="flex max-md:flex-col gap-6 pb-8 border-b border-black">
