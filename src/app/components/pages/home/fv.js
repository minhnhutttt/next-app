...
export default function FV() {
    ...
    return (
      <div className="bg-[url('/images/background-fv-sp.jpg')] md:bg-[url('/images/background-fv.jpg')] bg-cover max-md:h-screen flex items-end relative">
        <div ref={animateZoomRefs} className="opacity-0 absolute top-5 px-5 md:top-[10%] flex justify-center md:inset-x-0 md:px-10 max-md:z-30">
        ...
        <div ref={animateRefs} className="opacity-0 pt-[16.5%] w-full relative justify-center flex mx-auto max-md:z-10 overflow-hidden">
            <figure>
        ...
        <div ref={animateZoomRefs} className="opacity-0 absolute inset-x-0 md:px-10 px-8 bottom-12 md:bottom-10 max-md:z-20">
        ...
        <div ref={animateZoomRefs} className="opacity-0 absolute inset-x-0 px-4 md:px-10 max-md:top-[18vh] md:bottom-4 max-md:z-0">
