...
export default function Advantages() {
    ...
    return (
        <div id="advantages" className="px-5 relative md:pb-[82px] pb-12 md:pt-[100px] pt-[60px] overflow-hidden">
            <figure ref={animateRefs} className="max-md:w-[180px] max-[1440px]:w-[29.514vw] absolute bottom-0 right-0 z-10">
            ...
            <div className="w-full max-w-[1280px] mx-auto bg-[#FFF9F2]/[0.8] rounded-[10px] pt-10 pb-[120px] md:pt-20 md:pb-8 px-5 relative">
                ...
                <div className="w-full md:max-w-[1006px] max-w-[440px] mx-auto mt-8 md:mt-16">
                    <div className="flex md:gap-[50px] max-md:items-center max-md:flex-col gap-7">
                        <div ref={animateRefs} className="w-full md:w-[296px] rounded-[20px] overflow-hidden">
                        ...
                        <div ref={animateRefs} className="rounded-[20px] flex-1 overflow-hidden flex flex-col">
                    ...
                    <div className="py-10 relative z-10">
                        <div ref={animateRefs} className="flex justify-center items-center gap-8 md:gap-24">
                            <figure>
                        ...
                        <div ref={animateRefs} className="mt-12 min-[1441px]:w-full w-[70vw] md:w-[50vw] min-[1441px]:max-w-[757px] mx-auto">
