...
export default function HomeFeatures() {
    return (
      <div className="relative mb-16 md:mb-[160px] md:bg-[url('/bg-features-rp.png')] bg-[url('/bg-features-rp-sp.png')] bg-[length:100%_auto] bg-left-top max-md:pb-5">
        <div className="md:bg-[url('/bg-features.png')] bg-[url('/bg-features-sp.png')] bg-[length:100%_auto] bg-no-repeat bg-left-top px-5">
          <div className="relative w-full max-w-[400px] md:max-w-[1440px] mx-auto pt-10 md:pt-[76px] md:pr-[98px] pb-5 md:pb-[60px]">
              <h3 className="text-[32px] md:text-[48px] font-bold">Features</h3>
              <div className="grid md:grid-cols-3 gap-8 md:gap-10 md:mt-7 mt-5 max-md:w-[95%]">
