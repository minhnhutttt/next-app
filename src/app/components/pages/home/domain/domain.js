    ...
    return (
        <div className="md:pt-[87px] pt-12 overflow-hidden">
            ...
            <div className="pt-2 bg-white -md:mt-3">
                <div className="w-full max-w-[1256px] px-5 mx-auto">
                    <DomainItem
                        title={
                            <>
                            <span className="lg:text-[20px] text-[12px] md:text-[16px] font-noto font-bold">0xc142F69A269e3fa2D000F2f55D27EB8984B123F0</span>
                            <svg className="mx-auto my-1 md:my-3 max-md:w-6" width="46" height="34" viewBox="0 0 46 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M43.6986 7.4282e-06L2.29744 3.8088e-06C1.87827 0.0013011 1.4674 0.115435 1.10905 0.330116C0.750699 0.544798 0.458441 0.851896 0.263732 1.21836C0.0690224 1.58483 -0.0207669 1.99678 0.0040349 2.40988C0.0288367 2.82297 0.167286 3.22157 0.404483 3.56276L21.1051 33.0821C21.963 34.306 24.0285 34.306 24.8887 33.0821L45.5893 3.56276C45.8289 3.22228 45.9694 2.82349 45.9955 2.4097C46.0217 1.99592 45.9325 1.58297 45.7376 1.21573C45.5427 0.848491 45.2496 0.540997 44.8901 0.326664C44.5307 0.112331 44.1186 -0.000645556 43.6986 7.4282e-06Z" fill="#111111"/>
                            </svg>
                        ...
                        >
                        初期アイコンを好みの画像に変更するように、あなただけのWeb3.0アカウントの名前を自由に設定しよう！<br />
                        <br />
                        取得した次世代ドメイン名はNFT化され、ダイバーウォレットに保管されます。NFTなので、譲渡や売買も可能です。<br />
                        <br />
                        Web3.0の世界では、自分自身でIDを所持することができます。<br />企業によるアカウントの停止や禁止(垢BAN)などはありません。
                    </DomainItem>
                    <DomainItem
                        title={
                            <span>NFTの無料送信<br />を簡単に</span>
                        }
                        imageSrc="/images/img-domain-02.png"
                        >
                        ダイバーウォレットはNFTの受診だけではなく、送信が永年無料。長くて複雑なウォレットアドレスを覚えやすい名前に置き換えて、送り間違いともおさらば。<br />
                        NFTを交換しまくりましょう。
                    </DomainItem>
                    <DomainItem
                        title={
                    ...
                    <DomainItem
                        ...
                        >
                        暗号資産の管理やNFTを無料で送受信できる「DIVER Wallet」をはじめ、次世代型メッセージアプリ「DIVER Knock」、次世代のトレカ&クーポンサービス「トレクー」、NFTと位置情報をQRコードにセットできる「ChainPin」などのサービスでご利用頂けます。
                    </DomainItem>
                </div>
            </div>
        </div>
