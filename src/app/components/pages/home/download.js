...
export default function Download() {
  ...
  return (
    <div className="px-5 pb-6 pt-10 md:pb-[52px] md:pt-[86px]">
      <div
        ref={animateRefs}
        className="mx-auto w-full max-w-[1000px] rounded-[20px] border-[6px] border-[#2A5293] bg-white/90 px-5 py-7 md:py-10"
      >
        <div ref={animateRefs} className="mb-4 flex justify-center md:mb-6">
        ...
        <div className="mx-auto w-full max-w-[850px]">
          ...
          >
            ...
            <div className="flex-1">
              <p className="border-b border-black pb-2.5 text-[14px] font-bold tracking-wider md:pl-5 md:text-[24px]">
                <span className="text-[28px] md:text-[42px]">300</span>
                GBのオンラインストレージが付いてくる！
              </p>
              <div className="pt-3 md:pl-6 md:pt-5">
                ...
                <p className="text-[12px] leading-[1.8] md:text-[16px]">
                  ①無料のDIVER Walletをダウンロードし、ウォレット作成 <br />
                  ②DIVER Storageサイトへアクセスし、DIVER
                  Walletをコネクトするとストレージがご利用いただけます。
                </p>
              </div>
            </div>
          </div>
          <div
            ref={animateRefs}
            className="mt-5 flex justify-center gap-5 rounded-[20px] bg-[#2A5293] px-5 py-5 max-md:flex-col max-md:items-center md:mt-9 md:gap-10 md:py-9"
          >
            ...
            <div className="">
              ...
              <div className="mt-4 flex gap-4 max-md:flex-wrap max-md:justify-center md:mt-6 md:gap-10">
                <Link
