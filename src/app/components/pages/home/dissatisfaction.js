...
export default function Dissatisfaction() {
    ...
    return (
      <div className="bg-[url('/images/background-dissatisfaction.png')] bg-cover bg-top  flex items-end relative overflow-hidden">
        <div ref={animateRefs} className="absolute right-0 bottom-0">
