...
export default function SectionCard({ type, image, text, button, children, isComming }) {
    ...
    <div className="relative">
      {isComming &&
        <div className="absolute inset-0 z-50 flex items-center justify-center ">
          <span className="absolute inset-0 bg-[#344054]/[0.7] backdrop-filter backdrop-blur"></span>
      ...
      <div
      className="relative flex items-center justify-center overflow-hidden border border-black [box-shadow:0px_4px_4px_0px_rgba(0,_0,_0,_0.25)] md:min-h-[644px] min-h-[500px]"
      style={{ backgroundColor: getColorByIndex(type) }}>
        <figure>
          <img className="w-full" src={image} alt={type} />
        </figure>
        <div className="absolute w-full md:bottom-[4.167vw] bottom-[12vw] min-[1440px]:bottom-[60px]">
