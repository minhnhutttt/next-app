      ...
      {options.map((option, index) => (
        <label key={index} className="flex items-center">
          <input
            ...
            class="peer hidden"
          />
          <div class="inline-flex h-6 w-6 cursor-pointer items-center justify-center rounded-full border-[3px] border-[#333333] bg-white peer-checked:bg-[#333333] md:h-8  md:w-8 peer-checked:[&>span]:bg-white">
