        ...
        <div className="space-y-4 border-b border-[#313333] p-4 md:space-y-4 md:px-5 md:pt-11 md:pb-10">
          ...
          >
            <div className="flex items-center gap-8">
              ...
              <p className="text-left text-[16px] font-bold max-md:mt-0.5 md:text-[22px]">
                {question}
              </p>
            </div>
            <div className={`relative ml-2 flex h-5 w-5 items-center justify-center md:h-12 md:w-12 duration-150 ${open && 'rotate-180'}`}>
          ...
          {open && (
            <div className="flex pl-20">
              <p className="text-[14px] leading-[1.6] md:text-[16px] w-[85%] pb-7">
                {awnser}
              </p>
            </div>
          )}
...
export default function Faq() {
  return (
    <div className="pb-16 pt-16 md:pb-[145px] md:pt-[137px]">
      <div className="mx-auto w-full max-w-[940px] px-4 md:px-5">
        ...
        <div className="mx-auto mt-8 w-full border-t border-[#313333] md:mt-3">
          {data.map((data) => {
            return (
              <FaqItem
