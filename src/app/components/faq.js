...
const data = [
  ...
  },
  {
    id: "07",
    question:
      "What assets are supported for sending and receiving cryptocurrency on Knock?",
    awsner:
      "We currently support DIV and DRC20 tokens, as well as some DRC721/DRC1155 tokens.",
  },
];
...
function FaqItem({ id, question, awnser }) {
  ...
  return (
    <div className="space-y-4 border-b border-[#313333] p-4 md:space-y-4 md:px-5 md:pb-10 md:pt-11">
      <button
        type="button"
      ...
      {open && (
        <div className="flex pl-11 md:pl-20">
          <p className="pb-4 text-[14px] leading-[1.6] md:w-[85%] md:pb-7 md:text-[16px]">
            {awnser}
          </p>
        </div>
      )}
