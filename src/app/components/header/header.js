...
export default function Header() {
  ...
  return (
    <header className="px-4 md:px-8">
      <div className="mx-auto flex h-[60px] w-full max-w-[1440px] justify-between pt-3 md:h-[78px]">
          ...
          <div className="flex-1 max-lg:flex max-lg:justify-end lg:ml-6">
            ...
            >
              <div className="flex items-center">
                <ul className="flex items-center gap-5 max-lg:flex-col xl:gap-8">
                  <MenuItem link="/economics">Token Economics</MenuItem>
                  <MenuItem link="/product">Product</MenuItem>
                  <MenuItem link="#">Governance</MenuItem>
                  <MenuItem link="#">FAQ</MenuItem>
                  <MenuItem link="/disclaimer">Disclaimer</MenuItem>
