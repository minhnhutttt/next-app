...
export default function PrivacyPolicy() {
  ...
  return (
    <>
      ...
      <div className="px-5">
        <div ref={animateRefs} className="w-full max-w-[1190px] mx-auto opacity-0">
        ...
        <div className="mx-auto mb-16 mt-5 w-full max-w-[1000px] space-y-9 md:mb-20 md:mt-11">
            ...
            <TextBlock title="2. 利用目的">
                当社は、お客様の個人情報を、次に掲げる利用目的（以下、「本利用目的」といいます。）の範囲内において、取得及び利用いたします。
                    <p className="flex"><span className="w-4 mr-1 text-right">1.</span>サービスへの登録及びサービス利用時の本人確認並びにお客様の管理のため</p>
                    <p className="flex"><span className="w-4 mr-1 text-right">2.</span>商品等のお届け、ご提供、アフターサービスのため</p>
                    <p className="flex"><span className="w-4 mr-1 text-right">3.</span>商品等及びサービスの対価のご請求のため</p>
                    <p className="flex"><span className="w-4 mr-1 text-right">4.</span>不正行為等の防止及び対応のため</p>
                    <p className="flex"><span className="w-4 mr-1 text-right">5.</span>サービスの保守、管理のため</p>
                    <p className="flex"><span className="w-4 mr-1 text-right">6.</span>マーケティングデータの調査及び分析、並びに、マーケティング施策の検討及び実施のため</p>
                    <p className="flex"><span className="w-4 mr-1 text-right">7.</span>当社又は第三者の媒体において、お客様の属性・行動履歴の分析に基づく興味及び関心等に合わせ、当社又は第三者の商品等及びサービスの提供、勧誘、広告その他のマーケティングをするため</p>
                    <p className="flex"><span className="w-4 mr-1 text-right">8.</span>キャンペーン、懸賞企画、アンケートの実施のため</p>
                    <p className="flex"><span className="w-4 mr-1 text-right">9.</span>商品等及びサービスの改善のため、並びに、新たな商品等及びサービスの企画、研究及び開発のため</p>
                    <p className="flex"><span className="w-4 mr-1 text-right">10.</span>お問い合わせ対応及びお客様へのご連絡のため</p>
                    <p className="flex"><span className="w-4 mr-1 text-right">11.</span>本ポリシー記載の方法による、第三者に対する提供</p>
            </TextBlock>
            <TextBlock title="3. 第三者提供">
                （1）当社は、次に掲げる場合を除き、当社が取り扱う個人情報を、あらかじめお客様の同意を得ないで、第三者に提供いたしません。
                <p className="flex"><span className="w-4 mr-1 text-right">1.</span>法令に基づく場合</p>
                <p className="flex"><span className="w-4 mr-1 text-right">2.</span>人の生命、身体又は財産の保護のために必要がある場合であって、お客様の同意を得ることが困難であるとき</p>
                <p className="flex"><span className="w-4 mr-1 text-right">3.</span>公衆衛生の向上又は児童の健全な育成の推進のために特に必要がある場合であって、お客様の同意を得ることが困難であるとき</p>
                <p className="flex"><span className="w-4 mr-1 text-right">4.</span>国の機関若しくは地方公共団体又はその委託を受けた者が法令の定める事務を遂行することに対して協力する必要がある場合であって、お客様の同意を得ることにより当該事務の遂行に支障を及ぼすおそれがあるとき</p>
                <p className="flex"><span className="w-4 mr-1 text-right">5.</span>その他法令で認められる場合</p>
                （2）上記（1）にかかわらず、当社は、次に掲げる場合には、当社が取り扱う個人情報を第三者に提供することがあります。
                <p className="flex"><span className="w-4 mr-1 text-right">1.</span>お客様の興味・関心等に合わせた広告の配信及びその成果確認並びにサービスの提供のために、それ自体では特定の個人を識別できないようにした情報を当社と提携している広告配信事業者に提供する場合</p>
            </TextBlock>
            ...
            <TextBlock title="5. 開示等の請求">
                ...
                <p className="flex"><span className="w-4 mr-1 text-right">1.</span>開示することでご本人様又は第三者の生命、身体、財産その他の権利利益を書するおそれがある場合</p>
                <p className="flex"><span className="w-4 mr-1 text-right">2.</span>開示することで当社の業務の適正な実施に著しい支障を及ほすおそれがある場合</p>
                <p className="flex"><span className="w-4 mr-1 text-right">3.</span>開示することが法令に違反することとなる場合</p>
                <p className="flex"><span className="w-4 mr-1 text-right">4.</span>開示の請求がご本人様からであることが確認できない場合</p>
            ...
            <TextBlock title="6. Cookie の取扱い">
                ...
                <p className="flex"><span className="w-4 mr-1 text-right">1.</span>Cookieの概要</p>
                ...
                <p className="flex"><span className="w-4 mr-1 text-right">1.</span>第三者が提供する閲覧履歴等の収集・分析サービスの利用について</p>
