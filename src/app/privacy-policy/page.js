    ...
    <main>
      ...
      <div className="px-5">
        <div className="font-['Work_Sans] mx-auto mb-[100px] mt-5 w-full max-w-[1000px] space-y-8 md:mb-[155px] md:mt-7 md:space-y-10">
          <TextBlock>
            Thank you for using Knock. Knock allows you to encrypt and send
            audio, video, voice, text messages and files, and conduct voice
            calls, so that you can communicate safely, securely, anonymously —
            and easily. <br />
            <br />
            This document, our Privacy Policy, governs how Knock (collectively
            “we”, “us”, “Knock”) handles our users’ (“you,” “your,” etc.) data
            both in the Knock app itself (the “Knock App” or “Knock”) and on our
            website/servers (collectively, the “Services”).
            <br />
            <br />
            Our Privacy Policy is incorporated into and is subject to the Knock
            Terms of Service, so please read both documents carefully. Your use
            of the Services indicates your consent to this Privacy Policy and
            our Terms of Service. If you do not want to be bound by these
            agreements, you may not use our Services.
            <br />
            <br />
            Knock respects your privacy and strives to be as transparent as
            possible about how we use your personal information to provide you
            with secure services.Knock's security architecture and proprietary
            encryption methods are designed to ensure that only users designed
            to ensure that only users have access to message content.. Ever.
            Please contact us if you have any questions at info@knock.ooo
          </TextBlock>
          <TextBlock title="Conversation content">
            All conversation content is encrypted with strong encryption on the
            sender’s device and is only decrypted on the recipient’s device
            (also known as end-to-end encryption). This includes the files,
            images, audio, video, and location you decide to share in
            conversations or calls, which may also be personal and sensitive
          ...
          <TextBlock title="Sharing of Information">
            ...
            <ol className="list-decimal pl-6">
              ...
              <li>
                ...
                control and ownership; or, With your consent or at your
                direction.
              </li>
            </ol>
          </TextBlock>
          <TextBlock title="Cookie">
            Knock does not typically use cookies. It reserves the ability to use
            them to affect the availability and functionality of our Site. You
            can deny a website the possibility to store cookies or cache data.
            In order to deny cookies or the caching of data, the User needs to
            edit the User’s browser settings. Please note that the User may
            experience less availability and functionality when using the
